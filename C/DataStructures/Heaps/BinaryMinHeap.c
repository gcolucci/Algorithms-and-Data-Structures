 ...
 ******************************************************/
/**
 * Extracts the smallest element of the heap.
 *
 * It returns the minimum element of the heap and removes it from the
 * structure. If the heap is less than 25% occupied, it reduces it by half.
 *
 * @param heap: A pointer to the heap.
 * @return an int representing the minimum element or 0 if the heap is
 * empty.
 */
int extractHeap(Heap *heap) {
    int n, min, *allocResult;
